...
<style>
  ...
  .start-btn {
    ...
    border: none;
    border-radius: 50px;
    background: linear-gradient(90deg, #ff66b2, #ff1744);
    color: white;
    font-weight: bold;
    cursor: pointer;
  ...
  .hearts span {
    ...
    display: block;
    color: #ffb6c1;
    animation: float 10s linear infinite, colorShift 6s ease-in-out infinite alternate;
    bottom: -10%;
    text-shadow: 0 0 10px #ff4d6d, 0 0 25px #ff1744;
  }
...
<!-- الزر اللي بيبدأ كل حاجة -->
<div id="startScreen">
  <button class="start-btn" id="startBtn">💖 Start 💖</button>
</div>

<!-- الصفحة المخفية لحد ما تدوس -->
